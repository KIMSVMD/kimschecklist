...
const MANUAL_SECTIONS = [
  {
    ...
    steps: [
      ...
      '점검 월별 피드백 → 내가 올린 점검 확인 및 수정',
      '관리자 메뉴 → 비밀번호 입력 후 대시보드 이동',
    ],
  },
  {
    id: 'vm',
    ...
    steps: [
      '상단 "VM 점검" 탭 선택 후 지점·연도·월 선택',
      '빨간 숫자 뱃지가 있는 상품 = 아직 미제출 상품',
      '상품 선택 시 가이드 이미지 표시 (여러 장이면 좌·우 화살표로 넘기기)',
      '가이드 이미지를 탭하면 확대 · 핀치로 줌 가능',
      '체크리스트 항목별 우수 / 보통 / 미흡 선택 후 현장 사진 첨부',
      '제출 버튼 클릭 시 점검 완료',
    ],
  },
  {
    id: 'ad',
    title: '③ 광고 점검 등록',
    subtitle: '광고 체크리스트 및 영상 다운로드',
    steps: [
      '상단 "광고 점검" 탭 선택 (빨간 뱃지 = 광고 가이드가 있으면서 미제출 상품)',
      '상품 선택 후 상품명 오른쪽의 보라색 "영상" 버튼을 탭하면 광고 영상 다운로드 가능',
      '광고 가이드 이미지도 여러 장인 경우 좌·우 화살표로 넘겨서 확인',
      '광고 확인 여부 체크 후 현장 사진 첨부 및 제출',
    ],
  },
  {
    id: 'staff',
    ...
    steps: [
      ...
      '벨 아이콘에 뱃지가 뜨면 관리자 코멘트 또는 점수가 새로 등록된 것',
      '벨을 탭해 "코멘트/답글" · "점수 부여" · "새 가이드" 탭별로 확인',
      '카드에서 직접 답글 작성 가능',
