...
const MANUAL_SECTIONS = [
  ...
  },
  {
    id: 'vm',
    title: '② VM(진열) 점검 등록',
    subtitle: '매장 진열 상태 점검',
    steps: [
      '상단 [VM 점검] 탭 선택 후 지점 / 연도 / 월 설정',
      '카테고리(농산·수산·축산·공산) 선택',
  ...
  },
  {
    id: 'ad',
    title: '③ 광고(+셀링) 점검 등록',
    subtitle: '매장 광고물 및 셀링 운영 상태 점검',
    steps: [
      '상단 [광고 점검] 탭 선택 후 지점 / 연도 / 월 설정',
      '카테고리 → 품목군 → 상품 순서로 선택',
      '빨간 숫자 뱃지 = 아직 미완료 상품',
      '광고 영상이 있는 경우 가이드 상단 [영상] 버튼 → 광고 영상 다운로드',
      '가이드 이미지 확인 후 체크리스트 항목별 우수(○) / 미흡(✕) 선택',
