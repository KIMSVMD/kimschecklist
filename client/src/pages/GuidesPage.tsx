...
function GuideCard({ guide, onClick }: { guide: Guide; onClick: () => void }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full rounded-lg overflow-hidden" style={{ aspectRatio: '16/9', background: 'rgba(0,99,65,0.07)', border: '1.5px solid rgba(0,99,65,0.25)' }}>
        {images.length > 0 ? (
        ...
        <div className="overflow-y-auto flex-1 pb-10">
          ...
          {images.length > 0 && (
            <div className="px-4 pb-1">
              <div className="relative w-full rounded-2xl overflow-hidden" style={{ background: 'rgba(0,99,65,0.06)', border: '1.5px solid rgba(0,99,65,0.25)' }}>
                <img
                  src={images[imgIdx]}
                  alt={guide.product}
