...
export const checklists = pgTable("checklists", {
  ...
  qualityWeightedScore: text("quality_weighted_score"),
...
export const guides = pgTable("guides", {
  ...
  itemWeights: jsonb("item_weights").$type<Record<string, number>>(),
...
export const cleaningInspections = pgTable("cleaning_inspections", {
  ...
  items: jsonb("items").$type<Record<string, { status: string; beforePhotoUrl?: string | null; afterPhotoUrl?: string | null; memo?: string | null }>>(),
